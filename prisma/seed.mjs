...
const items = [
  ...
  { title: "Send the company update to my sister", type: "task", category: "business", important: true, deadline: at9(3), referee: "sister" },
  { title: "Prep the client deck section", type: "task", category: "work", important: true, deadline: at9(4), referee: "colleague" },
  ...
  { title: "Renew the gym membership", type: "task", category: "fitness", important: false, deadline: at9(7), referee: null },
  { title: "Reply to the building admin email", type: "task", category: "personal", important: false, deadline: at9(1), referee: null },
